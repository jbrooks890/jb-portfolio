...
export default function Blurb({ mode, pages, content }) {
  ...
  return (
    <div className="description flex col">
      ...
      <p>
        Hi, I’m Julian! I’m <em>{title.toLowerCase()}</em> based out of Smyrna,
        GA (20 minutes outside of Atlanta). I’m originally from Chicago, but was
        stationed in Florida, near Destin while serving in the Air Force.
      </p>
