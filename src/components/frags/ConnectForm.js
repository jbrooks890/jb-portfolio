...
export default function ConnectForm() {
  ...
  return (
    <form
      id="connect-form"
      className="flex w-screen flex-col gap-y-3 overflow-hidden rounded-lg border-2 border-lite/10 bg-nite p-4 py-header drop-shadow-lg duration-200 ease-out md:w-[90vmin] md:max-w-lg md:p-8"
